    ...
    <>
      ...
      <div className="flex sm:hidden rounded-xl border border-[var(--th-border)] bg-[var(--th-card)] px-4 py-3 flex-col gap-2 flex-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold text-[var(--th-txt-3)] shrink-0">{percentage.toFixed(0)}%</span>
        </div>
      </div>
      ...
      <div className="hidden sm:flex rounded-xl border border-[var(--th-border)] bg-[var(--th-card)] p-4 sm:p-6 flex-col gap-3 sm:gap-4 flex-1">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-end">
            <p className="text-xl sm:text-3xl font-bold leading-none">
              ...
              <span className="bg-gradient-to-r from-[#FF8C00] to-[#D81B60] bg-clip-text text-transparent">{goal}</span><span className="text-sm sm:text-lg font-normal text-[var(--th-txt-4)]"> und.</span>
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs sm:text-sm font-semibold text-[var(--th-txt-3)]">{percentage.toFixed(0)}%</span>
          </div>
